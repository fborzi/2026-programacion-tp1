#en este ejercicio se realizara el ingreso por teclado de una cadena y se dira la longuitud de la misma, si dicha cadena contiene 'la', las vocales en minusculas que tiene y se pasara la cadena a mayuscula
