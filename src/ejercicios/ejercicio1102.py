...
concatenaremos las dos cadenas haciendo que la segunda empiece con minuscula independientemente de como haya sido cargada,
por ultimo buscaremos y contaremos la cantidad de veces que aparece la primera letra de cadena1 en la cadena2 e 
...
print(cadena1 + cadena2[0].lower() + cadena2[1::])
print("la letra '", cadena1[0], "' aparece", cadena2.count(cadena1[0]), " veces en la cadena ", cadena2)