# en este ejercicio se pide ingresar dos cadenas para ver cuantas veces aparece la primer cadena en la segunda, generar una nueva cadena concatenando ambas y que la segunda cadena arranque en minuscula y por ultimo contar cuantas veces aparece la primera letra de la primer cadena en la segunda
